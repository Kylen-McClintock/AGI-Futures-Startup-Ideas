...
const neglectednessData = {
  ...
  "biophilia-ark": { score: 89, text: "Highly neglected. Consumer hardware intersecting with active bio-filtration and terrariums is a bizarre, high-friction space that software investors avoid entirely. It requires hardware, biological maintenance, and rigorous design expertise." },
