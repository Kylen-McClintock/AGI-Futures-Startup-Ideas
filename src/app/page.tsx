                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                            ...
                            <div className="flex items-center text-sm font-mono uppercase tracking-widest text-white/40 group-hover:text-[var(--primary)] transition-colors mt-auto">
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                            ...
                            <div className="flex items-center text-sm font-mono uppercase tracking-widest text-white/40 group-hover:text-emerald-400 transition-colors mt-auto">
                                View Prototype <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-2 transition-transform" />
                            </div>
                        </div>
                    </Link>
