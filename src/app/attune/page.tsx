  ...
  return (
    <main className="min-h-screen bg-transparent relative overflow-x-hidden selection:bg-amber-500/30 selection:text-amber-100 pb-32">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 mt-20 space-y-32">
        ...
        {/* Problem */}
        <RevealSection>
          <h2 className="text-4xl font-serif font-medium mb-8 text-amber-50">The Problem</h2>
        ...
        <RevealSection>
          <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
            <div>
              <h2 className="text-4xl font-serif font-medium mb-6 text-amber-50">The Solution</h2>
        ...
        <RevealSection>
          <div className="bg-white/5 rounded-3xl p-8 md:p-12 border border-white/10">
            <h2 className="text-3xl font-serif font-medium mb-12 text-center text-amber-50">Ideal Customer Profile</h2>
        ...
        <RevealSection>
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              <h2 className="text-3xl font-serif font-medium mb-6 text-amber-50">Why Now</h2>
        ...
        <RevealSection>
          <h2 className="text-3xl font-serif font-medium mb-8 text-amber-50 text-center">Business Model & GTM</h2>
        ...
        <RevealSection className="text-center max-w-3xl mx-auto space-y-16">
          ...
          <div className="pt-16 border-t border-white/10 relative">
            ...
            <h2 className="text-5xl font-serif text-white mb-8">Civilizational Impact</h2>
