...
import { ArrowRight, Activity, Brain, Shield, Users, Network, TrendingUp, ChevronDown } from "lucide-react";
  ...
  return (
    <main className="min-h-screen bg-transparent relative overflow-x-hidden selection:bg-[var(--primary)]/30 selection:text-[var(--primary)] pb-32" style={{ "--primary": themeMap['rose'].hexPrimary, "--secondary": themeMap['rose'].hexSecondary, "--tertiary": themeMap['rose'].hexTertiary } as React.CSSProperties}>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-24 px-6 md:px-12 lg:px-24">
        ...
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[var(--primary)]/20 via-[#060913] to-[#060913]">
          <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-[var(--primary)]/10 rounded-full blur-[120px] translate-x-1/3 -translate-y-1/3 pointer-events-none" />
        </div>
        ...
        <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <RevealSection delay={0.2} className="max-w-2xl">
            ...
            <h1 className="text-5xl md:text-7xl font-serif font-medium leading-[1.1] mb-6 tracking-tight text-white drop-shadow-2xl">
              An AI relationship coach to Make her feel <span className="text-[var(--secondary)] font-serif italic">heard, seen, and supported,</span> consistently.
            </h1>
            <p className="text-xl md:text-2xl text-slate-300 leading-relaxed font-light max-w-xl">
              It turns a <strong className="font-semibold text-[var(--primary)]">weekly couple sync, persistent relationship memory, and daily skill reps</strong> into a compounding loop for becoming a meaningfully better boyfriend or husband.
            </p>
            <div className="mt-6 mb-12 flex flex-col items-start -space-y-4">
              <InlineTags tags={initialTags?.sector} theme="rose" />
            </div>
            <div className="flex items-center gap-4">
              <button className="flex items-center gap-2 px-8 py-4 bg-[var(--primary)] hover:bg-[var(--secondary)] text-black font-semibold rounded-full transition-all hover:shadow-[0_0_30px_rgba(16,185,129,0.4)]">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 mt-20 space-y-32">
        ...
        <RevealSection>
          <div className="glass-panel p-8 md:p-12 rounded-3xl relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-64 h-64 bg-[var(--secondary)]/20 rounded-full blur-[80px] -z-10 group-hover:bg-[var(--secondary)]/30 transition-all duration-700" />
            <h2 className="text-sm font-bold tracking-widest text-[var(--secondary)] uppercase mb-8 flex items-center gap-2">
            ...
            <div className="text-2xl md:text-3xl lg:text-4xl font-serif leading-tight text-slate-100">
              In a randomized trial of <strong className="text-[var(--tertiary)] font-medium">215 couples</strong>, a brief recurring relationship checkup improved <strong className="text-[var(--tertiary)] font-medium">intimacy for the full 2-year follow-up</strong>, and also improved <strong className="text-[var(--tertiary)] font-medium">satisfaction and acceptance</strong>.
              <ExpandableCitation
                label="PMC Study"
        ...
        <RevealSection>
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
            <h2 className="text-4xl font-serif font-medium text-[var(--primary)]">The Problem</h2>
          </div>
          <div className="prose prose-invert prose-rose prose-lg max-w-none">
            ...
            <ul className="space-y-4 my-8 pl-0 list-none">
              {[
                ...
                <li key={i} className="flex gap-4 items-start bg-white/5 p-4 rounded-xl border border-white/5">
                  <div className="w-6 h-6 rounded-full bg-[var(--primary)]/50 border border-[var(--primary)]/30 flex items-center justify-center flex-shrink-0 mt-0.5">
            ...
            <div className="bg-[var(--primary)]/30 border-l-4 border-[var(--primary)] p-6 my-10 rounded-r-xl">
              <p className="text-xl font-serif text-[var(--primary)] m-0">
                So the core problem is not lack of love. It is lack of <strong className="text-[var(--secondary)] font-semibold">partner-specific relational skill</strong>, reinforced by weak feedback loops.
              </p>
            </div>
          </div>
        </RevealSection>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
            <div>
              <div className="flex flex-col gap-4 mb-2">
                <h2 className="text-4xl font-serif font-medium text-[var(--primary)]">The Solution</h2>
              </div>
              <div className="mb-6">
          ...
          <div className="prose prose-invert prose-rose prose-lg max-w-none">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-8">
              {['What felt good this week', 'Where either person felt disconnected', 'Upcoming stressors', 'One thing to improve next week', 'Shared goals', 'Intimacy and planning alignment', 'Preference updates'].map((item) => (
                <div key={item} className="px-4 py-3 glass rounded-lg text-sm font-medium text-[var(--primary)] flex items-center gap-2">
                  <ArrowRight className="w-4 h-4 text-[var(--primary)]" /> {item}
                </div>
              ))}
            </div>
            ...
            <div className="relative mt-12 p-8 rounded-2xl glass-panel border border-[var(--primary)]/20 text-center">
              <Brain className="w-10 h-10 text-[var(--secondary)] mx-auto mb-4" />
              <p className="text-xl text-slate-200">
                The app is not just a content library. It is a <strong className="text-[var(--secondary)]">relationship memory system</strong> that remembers what matters to <em>this</em> woman, where <em>this</em> man keeps missing, and which interventions actually improve the relationship.
              </p>
            </div>
          </div>
        </RevealSection>
        ...
        <RevealSection>
          <h2 className="text-4xl font-serif font-medium mb-8 text-[var(--primary)]">Optional Woman-Side Mode</h2>
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="grid md:grid-cols-2 gap-6 my-10">
              <div className="p-6 glass rounded-2xl border-t-2 border-t-[var(--primary)]">
                <h3 className="text-[var(--secondary)] font-bold mb-2 uppercase text-xs tracking-wider">Primary Mode</h3>
              ...
              <div className="p-6 glass rounded-2xl border-t-2 border-t-[var(--secondary)]">
                <h3 className="text-[var(--secondary)] font-bold mb-2 uppercase text-xs tracking-wider">Reciprocal Mode</h3>
        ...
        <RevealSection>
          <div className="bg-white/5 rounded-3xl p-8 md:p-12 border border-white/10">
            <div className="flex flex-col gap-4 mb-2 items-center">
              <h2 className="text-4xl font-serif font-medium text-center text-[var(--primary)]">Ideal Customer Profile</h2>
            </div>
            ...
            <div className="space-y-12">
              <div>
                <h3 className="text-xl font-bold text-[var(--secondary)] mb-4 flex items-center gap-2">
                  <span className="w-8 h-8 rounded-full bg-[var(--primary)] flex items-center justify-center text-sm">1</span>
                  Primary ICP
                </h3>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="p-6 bg-black/30 rounded-2xl">
                  <h4 className="text-[var(--tertiary)] font-semibold mb-2 text-sm uppercase tracking-wider">Economic Buyer Wedge</h4>
                ...
                <div className="p-6 bg-black/30 rounded-2xl">
                  <h4 className="text-[var(--tertiary)] font-semibold mb-2 text-sm uppercase tracking-wider">Secondary ICP</h4>
              ...
              <div className="border-t border-white/10 pt-8 mt-8">
                ...
                <div className="grid sm:grid-cols-3 gap-6">
                  {[
                    ...
                    <div key={i} className="text-sm italic text-slate-300 p-4 border-l-2 border-[var(--primary)]/50 bg-[var(--primary)]/5">
                      {quote}
                    </div>
                  ))}
                </div>
        ...
        <RevealSection>
          <h2 className="text-4xl font-serif font-medium mb-4 text-center text-[var(--primary)]">The Product</h2>
          <p className="text-center text-[var(--primary)]/60 mb-16 uppercase tracking-widest text-sm font-bold">The Core Loop is the Company</p>

          <CoreLoopVisual />

          <div className="mt-20 space-y-16">
            <h3 className="text-2xl font-serif text-[var(--tertiary)] mb-8 border-b border-white/10 pb-4">Product Layers</h3>

            <div className="grid md:grid-cols-2 gap-8">
              <FadeIn delay={0.1} className="glass p-6 rounded-2xl">
                <h4 className="text-[var(--secondary)] font-medium mb-3">1. Dual Onboarding</h4>
              ...
              <FadeIn delay={0.2} className="glass p-6 rounded-2xl">
                <h4 className="text-[var(--secondary)] font-medium mb-3">2. Weekly Couple Sync</h4>
              ...
              <FadeIn delay={0.3} className="glass p-6 rounded-2xl">
                <h4 className="text-[var(--secondary)] font-medium mb-3">3. Personalized Micro-lessons (For Him)</h4>
              ...
              <FadeIn delay={0.4} className="glass p-6 rounded-2xl">
                <h4 className="text-[var(--secondary)] font-medium mb-3">4. Role-specific Coaching (For Her)</h4>
                <ul className="text-sm text-slate-300 list-disc pl-5 space-y-1">
              ...
              <FadeIn delay={0.5} className="glass p-6 rounded-2xl">
                <h4 className="text-[var(--secondary)] font-medium mb-3">5. In-the-moment Coaching</h4>
              ...
              <FadeIn delay={0.6} className="glass p-6 rounded-xl col-span-1 md:col-span-2 relative overflow-hidden group">
                <div className="absolute inset-0 bg-[var(--primary)]/40 -z-10 group-hover:bg-[var(--primary)]/60 transition-colors" />
                <h4 className="text-[var(--tertiary)] font-medium mb-3 text-lg flex items-center gap-2">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <p className="text-[var(--primary)] font-semibold italic flex items-center text-sm md:text-base p-4 bg-[var(--primary)]/10 rounded-lg">
        ...
        {/* Cinematic Break */}
        <RevealSection className="w-full relative aspect-video rounded-[2rem] overflow-hidden my-24 border border-[var(--primary)]/20 shadow-2xl">
          <Image
...
<div className="grid md:grid-cols-2 gap-16">
            ...
            <div>
              <h2 className="text-4xl font-serif font-medium mb-6 text-[var(--primary)]">Market</h2>
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                {['Relationship wellness', 'Couples therapy light', 'Men’s self-improvement', 'AI coaching', 'Communication training', 'Intimacy & partnership'].map(t => (
                  <span key={t} className="px-3 py-1.5 bg-white/5 border border-white/10 rounded font-mono text-xs text-[var(--primary)]">{t}</span>
                ))}
              </div>
              <p className="text-[var(--primary)] font-medium italic border-l-2 border-[var(--primary)] pl-4 py-2 bg-[var(--primary)]/20 rounded-r-lg">
        ...
        <RevealSection>
          <div className="flex flex-col gap-4 mb-2 items-center">
            <h2 className="text-4xl font-serif font-medium text-[var(--primary)] text-center">Business Model</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="glass p-8 rounded-3xl">
              <h3 className="text-[var(--secondary)] font-bold mb-6 text-sm uppercase tracking-widest flex items-center gap-2">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <ul className="text-sm text-slate-300 space-y-2">
                    <li><strong className="text-[var(--primary)]">Attune for Him:</strong> personalized daily coaching based on weekly couple input</li>
                    <li><strong className="text-[var(--primary)]">Attune Couple:</strong> guided weekly sync plus coaching and shared progress dashboards</li>
                  </ul>
                </div>
                <div>
            ...
            <div className="glass p-8 rounded-3xl">
              ...
              <ul className="text-sm text-slate-300 space-y-6">
                <li>
                  <strong className="text-[var(--primary)] block mb-1">1. Woman-led invitation loop</strong>
                  "Here's an app I want us to try" is a more natural wedge than cold-start acquisition aimed only at men.
                </li>
                <li>
                  <strong className="text-[var(--primary)] block mb-1">2. Men's self-improvement framing</strong>
                  The product should feel like a high-leverage life upgrade, not a scolding.
                </li>
                <li>
                  <strong className="text-[var(--primary)] block mb-1">3. Creator-led acquisition</strong>
                  Therapists, couples creators, women explaining what "feeling heard" actually means.
                </li>
                <li>
                  <strong className="text-[var(--primary)] block mb-1">4. Viral content engine</strong>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              <div className="space-y-8">
                <p className="text-lg text-slate-300">
                  In an AGI-saturated world, the scarce value is not generic advice. It is: <span className="text-[var(--tertiary)]">persistent state, accurate diagnosis, contextual coaching, and measurable behavior change.</span>
                </p>
              ...
              <div className="space-y-6">
                <div className="p-5 glass-strong rounded-2xl">
                  <h4 className="text-[var(--secondary)] font-medium mb-2 text-sm uppercase tracking-widest">Data Moat</h4>
                ...
                <div className="p-5 glass-strong rounded-2xl">
                  <h4 className="text-[var(--secondary)] font-medium mb-2 text-sm uppercase tracking-widest">Memory Moat</h4>
                ...
                <div className="p-5 glass-strong rounded-2xl">
                  <h4 className="text-[var(--secondary)] font-medium mb-2 text-sm uppercase tracking-widest">Trust Moat</h4>
        ...
        <RevealSection className="text-center max-w-3xl mx-auto space-y-16">
          <div>
            <h2 className="text-sm font-bold tracking-widest text-[var(--primary)] uppercase mb-6">Transferable Insight</h2>
            <p className="text-2xl font-serif text-slate-100 leading-relaxed mb-8">
              "Most human relationships break down not because people do not care, but because feedback is <span className="text-[var(--secondary)]">too generic, too delayed, too emotionally messy,</span> and never converted into role-specific practice."
            </p>
          ...
          <div className="pt-16 border-t border-white/10 relative">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-[var(--primary)]/20 rounded-full blur-[40px] pointer-events-none" />
            <div className="flex flex-col gap-4 mb-2 items-center">
            ...
            <p className="text-[var(--secondary)] text-xl font-medium px-8 py-6 rounded-2xl glass-panel inline-block border-[var(--primary)]/30">
                ...
                <div>
                  ...
                  {cite.url && (
                    <a
                      ...
                      className="text-xs font-mono text-slate-400 hover:text-[var(--secondary)] transition-colors mt-1 inline-block"
                    >
                      View Source ↗
                    </a>
                  )}
