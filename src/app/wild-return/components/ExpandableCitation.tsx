    ...
    return (
        <div className="mt-24 pt-12 border-t border-white/10">
            <button 
                ...
                className="flex items-center gap-2 group w-full text-left outline-none mb-8"
            >
                <h3 className="text-sm font-mono uppercase tracking-widest text-white/40 group-hover:text-[var(--primary)] transition-colors">
                    References
                </h3>
                <ChevronDown className={`w-4 h-4 text-white/40 group-hover:text-[var(--primary)] transition-transform duration-300 ${isCollapsed ? 'rotate-[-90deg]' : 'rotate-0'}`} />
            </button>
            <AnimatePresence>
                {!isCollapsed && (
                    <motion.div 
                                    ...
                                    <div>
                                        ...
                                        {cite.url && (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-xs font-mono text-white/40 hover:text-[var(--primary)] transition-colors mt-1 inline-block border-b border-transparent hover:border-[var(--primary)]"
                                            >
                                                View Source ↗
                                            </a>
                                        )}
