...
export function UpliftChart() {
    return (
        <div className="w-full bg-zinc-900/50 rounded-2xl border border-white/10 p-6 sm:p-8 mt-8 mb-4 overflow-hidden relative backdrop-blur-sm">
            <h4 className="text-sm font-mono tracking-widest uppercase text-emerald-400 mb-8 flex items-center gap-3">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse relative">
                    <span className="absolute inset-0 rounded-full bg-emerald-400 blur-sm opacity-50"></span>
                </span>
            ...
            <div className="flex flex-col md:flex-row gap-8 lg:gap-16 items-start md:items-end justify-between h-auto md:h-64 mt-8 relative z-10">
                ...
                <div className="flex flex-col items-center gap-4 w-full md:w-1/3 relative group">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="h-56 w-full bg-emerald-900/20 border border-emerald-500/30 rounded-t-lg relative overflow-hidden flex items-end justify-center pb-4 shadow-[0_0_30px_rgba(16,185,129,0.15)] transition-all group-hover:border-emerald-400/50"
                    >
                        {/* Glow effect */}
                        <div className="absolute top-0 left-0 right-0 h-1 bg-emerald-400/50 blur-[2px]"></div>
                        <div className="absolute inset-x-0 bottom-0 h-full bg-gradient-to-t from-emerald-950/80 via-emerald-900/20 to-transparent pointer-events-none"></div>
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                            <motion.span
                                ...
                                className="text-emerald-300 font-mono text-xs mb-1 bg-emerald-950/80 px-2 py-0.5 rounded border border-emerald-500/20"
                            >
                                +14% GenAI Lift
                            </motion.span>
                            <span className="font-mono text-emerald-400 text-3xl font-light">1.14x</span>
                        </div>
                    </motion.div>
                    <div className="text-center mt-[-16px] md:mt-0">
                        <div className="text-xs font-mono uppercase tracking-widest text-emerald-400/70 mb-1">Optimized</div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12 relative z-10 border-t border-white/5 pt-8">
                <div className="bg-white/5 border border-white/5 rounded-xl p-4">
                    ...
                    <div className="text-emerald-400 font-mono text-lg">+0.2x margin</div>
                </div>
                <div className="bg-white/5 border border-white/5 rounded-xl p-4">
                    <div className="text-[10px] font-mono uppercase tracking-wider text-white/40 mb-2">Cash Conversion</div>
                    <div className="text-emerald-400 font-mono text-lg">-12 Days AR</div>
                </div>
                <div className="bg-white/5 border border-white/5 rounded-xl p-4">
            ...
            {/* Background decor */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-emerald-500/5 rounded-full blur-3xl pointer-events-none z-0"></div>
        </div>
    );
}
