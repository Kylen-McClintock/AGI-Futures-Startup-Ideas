                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-6">
                            ...
                            <ul className="space-y-4 text-white/70 font-light">
                                <li className="flex items-start gap-3"><span className="text-yellow-500 font-bold">•</span><span className="flex-1"><strong>Agent maturity.</strong> Field data shows double-digit productivity lifts in support and large gains in software tasks <ExpandableCitation label="[2]" sourceUrl="https://academic.oup.com/qje/article/140/2/889/7990658" sourceText="Brynjolfsson et al., Generative AI at Work" theme="zinc" /><ExpandableCitation label="[3]" sourceUrl="" sourceText="Support and Software task gains" theme="zinc" />.</span></li>
