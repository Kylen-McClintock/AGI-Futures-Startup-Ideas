        ...
        <main className="min-h-screen bg-[#06090c] text-slate-200 selection:bg-[var(--primary)]/30 font-sans pb-32" style={{ "--primary": themeMap['indigo'].hexPrimary, "--secondary": themeMap['indigo'].hexSecondary, "--tertiary": themeMap['indigo'].hexTertiary } as React.CSSProperties}>
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 mt-24">
                ...
                <header className="mb-32">
                    ...
                    >
                        <h1 className="text-5xl sm:text-7xl font-serif text-white mb-6 flex flex-col sm:flex-row sm:items-baseline gap-2 sm:gap-4">
                            Helm
                            <span className="text-2xl sm:text-4xl font-light text-[var(--tertiary)]/60 font-sans tracking-tight">| The playful office OS for solo founders</span>
                        </h1>
                ...
                <RevealSection className="mb-32">
                    <div className="glass-panel p-8 sm:p-10 rounded-3xl border border-white/5 bg-gradient-to-br from-[var(--primary)]/10 to-transparent hover:border-[var(--primary)]/30 transition-all duration-500 mb-12 group">
                        <p className="text-xl sm:text-2xl text-white/80 leading-relaxed font-serif italic border-l-4 border-[var(--primary)]/50 pl-6 group-hover:border-[var(--secondary)] transition-colors">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="glass-panel p-8 rounded-2xl border border-white/5 text-center">
                            <div className="text-4xl font-light text-[var(--secondary)] mb-2">64M</div>
                        ...
                        <div className="glass-panel p-8 rounded-2xl border border-white/5 text-center">
                            <div className="text-4xl font-light text-[var(--secondary)] mb-2">56%</div>
                ...
                <RevealSection className="mb-32">
                    ...
                    <div className="mb-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="glass-panel p-8 md:p-10 rounded-[2rem] border border-white/5 relative overflow-hidden group hover:border-[var(--primary)]/30 transition-colors">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="glass-panel p-8 md:p-10 rounded-[2rem] border border-white/5 hover:border-[var(--primary)]/30 transition-colors">
                                    ...
                                    <p className="text-white/80 leading-relaxed font-light text-lg">
                                        Agents share context, critique each other, decompose tasks, and hand off using multi-agent patterns validated in research <ExpandableCitation label="[6]" sourceUrl="https://github.com/microsoft/autogen" sourceText="AutoGen" theme="zinc" /><ExpandableCitation label="[7]" sourceUrl="https://github.com/camel-ai/camel" sourceText="CAMEL" theme="zinc" />.
                                    </p>
                                </div>
                            ...
                            <div className="glass-panel p-8 md:p-10 rounded-[2rem] border border-[var(--primary)]/20 bg-[var(--primary)]/10 hover:border-[var(--primary)]/40 transition-colors">
                                <h4 className="text-2xl font-medium text-white mb-4 flex items-center gap-3">
                                    <Network className="w-7 h-7 text-[var(--secondary)]" />
                                    Opt-in network rail with concrete flows
                                </h4>
                                <p className="text-white/80 leading-relaxed font-light text-lg mb-8">
                                    Connect Farcaster and AT Protocol for portable social graphs, plus LinkedIn, Instagram, and email. Helm builds opt-in help cohorts so you never spam your network. People volunteer for specific streams and time budgets. Helm routes asks with context, constraints, and an acceptance test <ExpandableCitation label="[8]" sourceUrl="https://docs.farcaster.xyz" sourceText="Farcaster" theme="zinc" /><ExpandableCitation label="[9]" sourceUrl="https://atproto.com" sourceText="AT Protocol" theme="zinc" />.
                                </p>
                                <div className="space-y-4">
                                    <div className="p-5 rounded-xl bg-white/[0.02] border border-white/5 border-l-2 border-l-[var(--primary)]/50">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                ...
                                <div className="glass-panel p-8 md:p-10 rounded-[2rem] border border-white/5 hover:border-[var(--primary)]/30 transition-colors">
                                    <h4 className="text-2xl font-medium text-white mb-4 flex items-center gap-3">
                                        <UserPlus className="w-7 h-7 text-[var(--secondary)]" />
                            ...
                            <div className="glass-panel p-8 md:p-10 rounded-[2rem] border border-white/5 hover:border-[var(--primary)]/30 transition-colors">
                                <h4 className="text-2xl font-medium text-white mb-6 flex items-center gap-3">
                                    <Layers className="w-7 h-7 text-[var(--secondary)]" />
                ...
                <RevealSection className="mb-32">
                    <div className="mb-12">
                        <div className="text-sm font-mono tracking-widest uppercase text-[var(--secondary)] mb-4 flex items-center">
                            <span className="w-8 h-px bg-[var(--primary)]/50 mr-4" /> ICP
                        </div>
                    ...
                    <div className="glass-panel p-8 sm:p-12 rounded-[2rem] border border-[var(--primary)]/20 bg-[var(--primary)]/20 relative overflow-hidden group">
                        ...
                        <p className="text-lg leading-relaxed text-[var(--tertiary)] font-medium mt-6 relative z-10 border-l-2 border-[var(--primary)] pl-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-6">
                            ...
                            <ul className="space-y-4 text-white/70 font-light">
                                <li className="flex items-start gap-3"><span className="text-yellow-500 font-bold">•</span><span className="flex-1"><strong>Agent maturity.</strong> Field data shows double-digit productivity lifts in support and large gains in software tasks <ExpandableCitation label="[2]" sourceUrl="https://academic.oup.com/qje/article/140/2/889/7990658" sourceText="Brynjolfsson et al., Generative AI at Work" theme="zinc" /><ExpandableCitation label="[3]" sourceUrl="https://mitsloan.mit.edu/ideas-made-to-matter/generative-ai-improves-highly-skilled-workers-productivity" sourceText="Support and Software task gains" theme="zinc" />.</span></li>
                                <li className="flex items-start gap-3"><span className="text-yellow-500 font-bold">•</span><span className="flex-1"><strong>Open social graphs.</strong> Protocols like Farcaster and AT enable portable identity and relationships across apps, making opted-in micro-advisory practical at scale <ExpandableCitation label="[8]" sourceUrl="https://docs.farcaster.xyz" sourceText="Farcaster" theme="zinc" /><ExpandableCitation label="[9]" sourceUrl="https://atproto.com" sourceText="AT Protocol" theme="zinc" />.</span></li>
                ...
                <RevealSection className="mb-32">
                    <div className="mb-12">
                        <div className="text-sm font-mono tracking-widest uppercase text-[var(--secondary)] mb-4 flex items-center">
                            <span className="w-8 h-px bg-[var(--primary)]/50 mr-4" /> Mechanics & GTM
                        </div>
                        <h2 className="text-4xl sm:text-5xl font-light text-white tracking-tight leading-tight mb-4">
                    ...
                    <div className="glass-panel p-8 sm:p-10 rounded-[2rem] border border-white/5 relative overflow-hidden group mb-8">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-[var(--primary)]/10 blur-[80px] pointer-events-none" />
                        <h3 className="text-2xl font-light text-white mb-4 flex items-center gap-3 relative z-10">
                            <Briefcase className="w-6 h-6 text-[var(--secondary)]" /> Business Model
                        </h3>
                        <p className="text-lg leading-relaxed text-white/80 font-light relative z-10">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-8">
                        <details className="glass-panel p-8 sm:p-10 rounded-[2rem] border border-[var(--primary)]/20 bg-[var(--primary)]/20 hover:border-[var(--primary)]/40 transition-colors group [&_summary::-webkit-details-marker]:hidden cursor-pointer">
                            <summary className="list-none outline-none">
                                <div className="flex justify-between items-start mb-6 border-b border-[var(--primary)]/20 pb-6">
                                    ...
                                    <div className="text-right flex items-center gap-4">
                                        ...
                                        <div>
                                            <div className="text-3xl font-light text-[var(--secondary)]">{scores.moat_score} <span className="text-base text-white/40">/ 100</span></div>
                                            <div className="text-xs uppercase tracking-widest text-[var(--secondary)]/60 font-mono mt-1">Potential</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="group-open:hidden">
                                    ...
                                    <div className="text-[var(--secondary)] text-sm mt-4 font-medium flex items-center gap-2">Read full evaluation</div>
                                </div>
                            </summary>
                            <div className="space-y-4">
                                ...
                                <p className="text-white/80 leading-relaxed font-light border-l-2 border-[var(--primary)] pl-4 mt-6">
                            ...
                            <summary className="list-none outline-none">
                                <div className="flex justify-between items-start mb-6 border-b border-[var(--primary)]/20 pb-6">
                                    ...
                                    <div className="text-right flex items-center gap-4">
                                        <ChevronDown className="w-6 h-6 text-[var(--primary)]/50 group-open:rotate-180 transition-transform duration-300" />
                                        <div>
                                            <div className="text-3xl font-light text-[var(--secondary)]">{scores.difficulty_score} <span className="text-base text-white/40">/ 100</span></div>
                                            <div className="text-xs uppercase tracking-widest text-[var(--secondary)]/60 font-mono mt-1">To Market</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="group-open:hidden">
                        ...
                        <summary className="list-none outline-none">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <div className="flex items-center gap-3">
                                    <span className="hidden sm:inline-block px-3 py-1 rounded-full border border-[var(--primary)]/30 bg-[var(--primary)]/10 text-[var(--secondary)] font-mono text-xs tracking-widest font-bold">HIGH EXECUTION RISK</span>
                            ...
                            <div className="grid sm:grid-cols-4 gap-4 group-open:hidden">
                                <div className="p-4 rounded-xl border border-white/5 bg-black/20 text-center"><span className="block text-white font-medium mb-1">Tech</span><span className="text-[var(--secondary)] font-mono text-xs">Medium</span></div>
                                <div className="p-4 rounded-xl border border-white/5 bg-black/20 text-center"><span className="block text-white font-medium mb-1">Regulatory</span><span className="text-[var(--secondary)] font-mono text-xs">Low-Med</span></div>
                                <div className="p-4 rounded-xl border border-white/5 bg-black/20 text-center"><span className="block text-white font-medium mb-1">Capital</span><span className="text-[var(--secondary)] font-mono text-xs">Medium</span></div>
                                <div className="p-4 rounded-xl border border-[var(--primary)]/30 bg-[var(--primary)]/30 text-center shadow-[inset_0_0_20px_rgba(225,29,72,0.1)]"><span className="block text-[var(--primary)] font-medium mb-1">Execution</span><span className="text-[var(--secondary)] font-mono text-xs font-bold">High</span></div>
                            </div>
                        </summary>

                        <div className="grid sm:grid-cols-2 gap-4 pt-8 border-t border-white/10 mt-6">
                            <div className="glass-panel p-6 rounded-2xl border border-[var(--primary)]/10 hover:border-[var(--primary)]/30 transition-colors">
                                <div className="flex justify-between mb-3"><strong className="text-white">Tech</strong> <span className="text-[var(--secondary)] font-mono text-sm">Medium</span></div>
                                <ul className="space-y-3 text-sm font-light">
                                    <li className="text-white/70"><strong className="text-[var(--tertiary)] font-medium">Risk:</strong> Multi-agent systems still fail silently, over-delegate, or create brittle handoffs in long workflows.</li>
                                    <li className="text-white/70"><strong className="text-[var(--tertiary)] font-medium">Mitigation:</strong> Start with narrow, repeatable founder workflows. Keep human approval gates default-on. Make traces replayable, benchmarked, and rollback-ready before expanding autonomy.</li>
                                </ul>
                            </div>
                            <div className="glass-panel p-6 rounded-2xl border border-[var(--primary)]/10 hover:border-[var(--primary)]/30 transition-colors">
                                <div className="flex justify-between mb-3"><strong className="text-white">Regulatory</strong> <span className="text-[var(--secondary)] font-mono text-sm">Low-Medium</span></div>
                                <ul className="space-y-3 text-sm font-light">
                                    <li className="text-white/70"><strong className="text-[var(--tertiary)] font-medium">Risk:</strong> Marketplace labor classification, adviser representations, and data handling create compliance surface area, especially if Helm starts resembling hiring infrastructure or financial advice.</li>
                                    <li className="text-white/70"><strong className="text-[var(--tertiary)] font-medium">Mitigation:</strong> Avoid regulated claims early. Position mentors as educational and decision-support tools, not fiduciaries. Keep clean terms, provenance, disclosures, and role boundaries from day one.</li>
                                </ul>
                            </div>
                            <div className="glass-panel p-6 rounded-2xl border border-[var(--primary)]/10 hover:border-[var(--primary)]/30 transition-colors">
                                <div className="flex justify-between mb-3"><strong className="text-white">Capital</strong> <span className="text-[var(--secondary)] font-mono text-sm">Medium</span></div>
                                <ul className="space-y-3 text-sm font-light">
                                    <li className="text-white/70"><strong className="text-[var(--tertiary)] font-medium">Risk:</strong> Great product design, agent infrastructure, and liquidity on both advisor and freelancer rails require meaningful upfront investment before the network is fully self-reinforcing.</li>
                                    <li className="text-white/70"><strong className="text-[var(--tertiary)] font-medium">Mitigation:</strong> Launch with one killer wedge workflow and a manually curated network. Earn revenue before building full marketplace breadth. Use services and concierge layers to bootstrap high-value traces.</li>
                                </ul>
                            </div>
                            <div className="glass-panel p-6 rounded-2xl border border-[var(--primary)]/10 hover:border-[var(--primary)]/30 transition-colors">
                                <div className="flex justify-between mb-3"><strong className="text-white">Execution</strong> <span className="text-[var(--secondary)] font-mono text-sm">High</span></div>
                                <ul className="space-y-3 text-sm font-light">
                                    <li className="text-white/70"><strong className="text-[var(--tertiary)] font-medium">Risk:</strong> This product can easily become bloated, confusing, or gimmicky. If it feels like a toy, founders will churn. If it feels like enterprise software, they will also churn.</li>
                                    <li className="text-white/70"><strong className="text-[var(--tertiary)] font-medium">Mitigation:</strong> Obsess over one moment of undeniable relief. Make the first room feel like superpowers, not software. Build from repeated daily use cases outward, not from platform ambition inward.</li>
                                </ul>
                            </div>
                        </div>
                    </details>
                    ...
                    <div>
                        ...
                        <div className="glass-panel p-8 sm:p-10 rounded-[2rem] border border-[var(--primary)]/20 bg-[var(--primary)]/10 relative overflow-hidden">
                            <h4 className="text-2xl font-medium text-white mb-4 flex items-center gap-3">
                            ...
                            <div className="p-6 rounded-2xl border border-[var(--primary)]/20 bg-[var(--primary)]/5">
                                <h5 className="font-medium text-[var(--tertiary)] mb-2 font-mono uppercase tracking-widest text-sm">User Wedge</h5>
                ...
                <RevealSection className="mb-32">
                    <div className="mb-12">
                        <div className="text-sm font-mono tracking-widest uppercase text-[var(--secondary)] mb-4 flex items-center">
                            <span className="w-8 h-px bg-[var(--primary)]/50 mr-4" /> Trajectory
                        </div>
                        <h2 className="text-4xl sm:text-5xl font-light text-white tracking-tight leading-tight">
                            AGI Future Edge.
                        </h2>
                    ...
                    <details className="group [&_summary::-webkit-details-marker]:hidden">
                        <summary className="list-none outline-none cursor-pointer">
                            <div className="flex justify-center items-center py-4 border border-[var(--primary)]/20 bg-[var(--primary)]/20 hover:bg-[var(--primary)]/30 rounded-2xl transition-colors group-open:hidden gap-3 shadow-[0_0_15px_rgba(20,184,166,0.1)]">
                                <span className="text-[var(--secondary)] font-medium">Reveal 4 more Trajectory edges</span>
                                <ChevronDown className="w-5 h-5 text-[var(--secondary)]" />
                            </div>
                        </summary>
                        ...
                        <div className="grid sm:grid-cols-2 gap-6 pb-6 pt-4">
                            ...
                            <div className="glass-panel p-8 rounded-[2rem] border border-[var(--primary)]/20 hover:border-[var(--primary)]/40 transition-colors bg-[var(--primary)]/5">
                                ...
                                <p className="text-white/70 leading-relaxed font-light">
                                    This is the main prize. As more workflows hit L3 and L4 and unit economics clear, Jarvis runs revenue lines end to end under policy constraints with auditable records and programmatic payments. It replicates proven playbooks into new products and geographies, hires agents, contracts freelancers, and maintains books with verifiable logs. Over time, Helm graduates from an office operating system to a factory for legally bounded, truly autonomous entities <ExpandableCitation label="[6]" sourceUrl="https://github.com/microsoft/autogen" sourceText="AutoGen" theme="zinc" /><ExpandableCitation label="[7]" sourceUrl="https://github.com/camel-ai/camel" sourceText="CAMEL" theme="zinc" /><ExpandableCitation label="[10]" sourceUrl="https://www.w3.org/TR/did-core/" sourceText="Decentralized IDs" theme="zinc" /><ExpandableCitation label="[11]" sourceUrl="https://www.w3.org/TR/vc-data-model-2.0/" sourceText="Verifiable Credentials" theme="zinc" />.
                                </p>
                            </div>
                        </div>
                    </details>
                ...
                <RevealSection className="mb-32">
                    <div className="mb-12">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-4">
                            <div className="text-sm font-mono tracking-widest uppercase text-[var(--secondary)] flex items-center">
                                <span className="w-8 h-px bg-[var(--primary)]/50 mr-4" /> Civilizational Impact
                            </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 mb-16">
                        <div className="space-y-6 lg:pr-8">
                            <p className="text-xl leading-relaxed text-white/80 font-light border-l-2 border-[var(--primary)]/50 pl-6 space-y-4 flex flex-col">
                            ...
                            <details className="mt-8 glass-panel rounded-[2rem] border border-[var(--primary)]/20 bg-[var(--primary)]/20 hover:bg-[var(--primary)]/30 hover:border-[var(--primary)]/40 transition-all duration-300 group overflow-hidden cursor-pointer [&_summary::-webkit-details-marker]:hidden w-full sm:w-[320px]">
                                ...
                                <div className="px-6 pb-6 pt-2 border-t border-[var(--primary)]/10 space-y-3">
                                    {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                                    {Object.entries(scores.civilizational_impact_ratings).map(([key, data]: [string, any]) => (
                                        <div key={key} className="flex justify-between items-center text-sm">
                                            <span className="text-[var(--primary)]/70 font-light">{key}</span>
                                            <span className="text-[var(--secondary)] font-mono">{data.ai_scored}</span>
                                        </div>
                                    ))}
                                </div>
                            </details>
                        ...
                        <div className="space-y-12">
                            <div className="glass-panel p-8 rounded-3xl border border-white/5 hover:border-[var(--primary)]/20 transition-all">
                                ...
                                <ul className="space-y-4 text-white/80 font-light">
                                    <li className="flex items-start gap-4"><CheckCircle2 className="w-5 h-5 text-[var(--primary)] shrink-0" /> Time-to-ship for first meaningful output</li>
                                    <li className="flex items-start gap-4"><CheckCircle2 className="w-5 h-5 text-[var(--primary)] shrink-0" /> Weekly active founders</li>
                                    <li className="flex items-start gap-4"><CheckCircle2 className="w-5 h-5 text-[var(--primary)] shrink-0" /> Advisor response rate on opted-in asks</li>
                                    <li className="flex items-start gap-4"><CheckCircle2 className="w-5 h-5 text-[var(--primary)] shrink-0" /> Trace-to-signup conversion from shared builds</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <details ref={firstExpRef} className="glass-panel rounded-[2rem] border border-white/5 hover:border-[var(--primary)]/30 transition-all duration-300 group overflow-hidden cursor-pointer [&_summary::-webkit-details-marker]:hidden bg-white/[0.01]">
                            <summary className="p-8 outline-none flex justify-between items-center">
                                <div>
                                    <h3 className="text-2xl font-light text-white mb-2 group-hover:text-[var(--tertiary)] transition-colors">First Experiment</h3>
                                    <p className="text-white/50 font-light text-sm italic">Validation via a 48-hour challenge using multi-agent output.</p>
                                </div>
                                <ChevronDown className="w-6 h-6 text-[var(--primary)]/50 group-open:rotate-180 transition-transform duration-300" />
                            </summary>
                            <div className="px-8 pb-8 pt-4 border-t border-white/10 bg-[var(--primary)]/50">
                                <p className="text-white/80 font-light leading-relaxed mb-6 border-l-2 border-[var(--primary)]/30 pl-4">
                                    <strong className="text-[var(--tertiary)] font-medium">Design:</strong> 10 founders, one Marketing room, ship a landing page plus three ad variants using a Copywriter agent, an Analyst agent, and one vetted micro-review in 48 hours.
                                </p>
...
<div className="mb-16">
                ...
                <RevealSection className="border-t border-white/10 pt-12">
                    <details className="group [&_summary::-webkit-details-marker]:hidden">
                        <summary className="flex items-center gap-3 cursor-pointer outline-none">
                            <h3 className="text-lg font-mono tracking-widest uppercase text-white/40 group-hover:text-[var(--secondary)] transition-colors">
                                Acronyms & References
                            </h3>
                            <ChevronDown className="w-5 h-5 text-white/40 group-hover:text-[var(--secondary)] group-open:rotate-180 transition-all duration-300" />
                        </summary>
            ...
            <div className="pt-8">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <div className="bg-white/[0.02] border border-white/5 rounded-xl p-4">
                                        <div className="text-[var(--secondary)] font-mono text-sm mb-1">SaaS</div>
                                        <div className="text-white/60 text-sm font-light">Software as a Service</div>
                                    </div>
                                    <div className="bg-white/[0.02] border border-white/5 rounded-xl p-4">
                                        <div className="text-[var(--secondary)] font-mono text-sm mb-1">PRD</div>
                                        <div className="text-white/60 text-sm font-light">Product Requirements Document</div>
                                    </div>
                                    <div className="bg-white/[0.02] border border-white/5 rounded-xl p-4">
                                        <div className="text-[var(--secondary)] font-mono text-sm mb-1">SMEs</div>
                                        <div className="text-white/60 text-sm font-light">Small and Medium-sized Enterprises</div>
                                    </div>
                                    <div className="bg-white/[0.02] border border-white/5 rounded-xl p-4">
                                        <div className="text-[var(--secondary)] font-mono text-sm mb-1">ICP</div>
                                        <div className="text-white/60 text-sm font-light">Ideal Customer Profile</div>
                                    </div>
                                    <div className="bg-white/[0.02] border border-white/5 rounded-xl p-4">
                                        <div className="text-[var(--secondary)] font-mono text-sm mb-1">L3/L4</div>
                                    ...
                                    {citations.map((cite) => (
                                        <div key={cite.number} className="glass-panel p-6 rounded-2xl border border-white/5 hover:bg-white/[0.02] transition-colors flex gap-4">
                                            ...
                                            <div className="text-sm text-white/50 font-light leading-relaxed w-full flex flex-col md:flex-row md:justify-between md:items-center">
                                                ...
                                                {cite.url && (
                                                    <a href={cite.url} target="_blank" rel="noreferrer" className="text-[var(--secondary)] hover:text-[var(--tertiary)] hover:underline mt-2 md:mt-0 font-medium whitespace-nowrap md:ml-4 flex items-center gap-1">
