...
import { ChevronDown, Shield, TrendingUp, FlaskConical } from "lucide-react";

interface InteractiveScoreCardProps {
    title: string;
    score?: number;
    maxScore?: number;
    type: "moat" | "difficulty" | "experiment";
...
export function InteractiveScoreCard({
    ...
    const Icon = type === "moat" ? Shield : type === "difficulty" ? TrendingUp : FlaskConical;
        ...
        <div className={`glass-panel p-6 sm:p-8 rounded-3xl border ${themeClass.split(' ')[1]} relative overflow-hidden group mb-8`}>
            ...
            <div className="relative z-10">
                ...
                <button
                    ...
                    className={`mt-6 flex items-center text-sm font-mono uppercase tracking-widest ${themeClass.split(' ')[0]} opacity-80 hover:opacity-100 transition-opacity cursor-pointer z-20 relative`}
                >
