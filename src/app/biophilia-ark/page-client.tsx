                ...
                >
                    ...
                    <div className="glass-panel p-8 sm:p-12 rounded-3xl border border-[var(--primary)]/20 bg-gradient-to-br from-[var(--primary)]/10 to-transparent flex flex-col md:flex-row gap-12 items-center group">
                        <div className="md:w-1/2 relative h-80 w-full rounded-2xl overflow-hidden border border-white/10 group-hover:border-[var(--primary)]/30 transition-colors">
                            <Image src={dartFrog} alt="Dart frog on moss" fill className="object-cover transition-transform duration-1000 group-hover:scale-110" />
                        </div>
                        <div className="md:w-1/2">
                            <h3 className="text-3xl font-light text-white mb-4">Cloud Forest Wall</h3>
                            <p className="text-lg text-white/80 font-light leading-relaxed mb-6">Moss, bromeliads, orchids, dripping stone, mist, layered depth, and root-like geometry. This is the highest-emotion product and one of the clearest portal experiences.</p>
                            <div className="space-y-3 text-sm text-[var(--tertiary)] bg-white/5 p-6 rounded-2xl">
                                <p><strong className="text-white font-medium">Fauna:</strong> Small captive-bred amphibians (dart frogs), leaf-cutter ant colonies with visible foraging paths, walking sticks, and butterflies in large builds.</p>
                                <p><strong className="text-white font-medium">Why it works:</strong> It feels alive in multiple ways at once: color, moisture, movement, and behavior.</p>
                            </div>
                        </div>
                    </div>
                </motion.section>
