...
export function InteractiveScoreCard({
    ...
    return (
        <div className={`glass-panel p-6 sm:p-8 rounded-[2rem] border ${themeClass.split(' ')[1]} relative overflow-hidden group mb-8`}>
            ...
            <div className="relative z-10">
                ...
                <AnimatePresence>
                    {isExpanded && (
                        ...
                        >
                            <div className="pt-6 mt-4 border-t border-[var(--primary)]/20 text-white/70 space-y-4 leading-relaxed font-light">
                                {expandableText}
                            </div>
                        </motion.div>
                    )}
