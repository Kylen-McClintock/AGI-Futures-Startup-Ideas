...
export function InteractiveScoreCard({
    ...
    return (
        <div className={`glass-panel p-6 sm:p-8 rounded-3xl border ${themeClass.split(' ')[1]} relative overflow-hidden group mb-8`}>
            <div className={`absolute inset-0 bg-gradient-to-br ${themeClass.split(' ')[2]} to-transparent z-0 pointer-events-none opacity-50 bg-[var(--primary)]/5`} />
            ...
            <div className="relative z-10">
                ...
                <AnimatePresence>
                    {isExpanded && (
                        ...
                        >
                            <div className="pt-6 mt-2 border-t border-[var(--primary)]/10 text-white/70 space-y-4 leading-relaxed font-light">
                                {expandableText}
                            </div>
                        </motion.div>
                    )}
