    ...
    return (
        <div className="min-h-screen bg-[#f8fcf5] dark:bg-[#070c08] text-zinc-900 dark:text-zinc-100 font-sans selection:bg-emerald-200 dark:selection:bg-emerald-900 overflow-x-hidden relative">
            ...
            >
                ...
                >
                    <Image src="/images/us_block_party.png" alt="A lively block party in a typical US suburban cul-de-sac with a Homegrown Ales banner" fill className="object-cover" priority />
                </motion.div>
            </motion.section>
            ...
            <section className="relative z-30 py-32">
                <GridContainer>
                    ...
                    >
                        <Image src="/images/lush_neighborhood_street.png" alt="A lush pedestrianized futuristic street with open garages" fill className="object-cover" />
                    </motion.div>
                ...
                <GridContainer className="relative z-10">
                    <div className="flex flex-col md:flex-row gap-12 mb-20 items-center">
                        ...
                        <div className="md:w-1/2 w-full">
                            ...
                            >
                                <Image src="/images/us_suburb_bakery.png" alt="A typical American suburban garage converted into a neighborhood micro-bakery" fill className="object-cover" />
                            </motion.div>
                        </div>
                    </div>
                ...
                <GridContainer>
                    <div className="flex flex-col md:flex-row gap-16">
                        ...
                        <div className="md:w-2/3">
                            ...
                            >
                                <Image src="/images/us_suburb_repair_cafe.png" alt="A standard American suburban house with a repair cafe in the garage" fill className="object-cover" />
                            </motion.div>
                        </div>
                    </div>
                </GridContainer>
                ...
                <GridContainer>
                    <div className="grid md:grid-cols-2 gap-16 md:gap-24">
                        ...
                        <div>
                            ...
                            >
                                <Image src="/images/hero_garage_cafe.png" alt="Open residential garage converted into a vibrant micro-cafe on a retro-futuristic suburban street" fill className="object-cover" />
                            </motion.div>
                        </div>
                    </div>
                </GridContainer>
