...
export function PageClient() {
    return (
        <main className="min-h-screen bg-stone-950 text-stone-300 font-sans selection:bg-cyan-500/30 relative">
            ...
            <section className="relative px-6 pt-12 pb-24 md:pt-24 md:pb-32 max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-xs font-mono uppercase tracking-widest mb-8">
                    ...
                    >
                        <div className="absolute inset-0 bg-gradient-to-tr from-cyan-500/20 to-transparent z-10 mix-blend-overlay" />
                        <Image
                            src={heroImg}
            ...
            <section className="px-6 py-24 bg-zinc-900/30 border-y border-white/5">
                <motion.div {...FADE_UP} className="max-w-4xl mx-auto text-center">
                    <p className="text-2xl md:text-3xl lg:text-4xl text-white font-serif leading-relaxed font-light">
                        ...
                        <span className="text-cyan-400"> Agentable makes that operating system readable in real time. </span>
            ...
            <section className="px-6 py-24 max-w-5xl mx-auto">
                <motion.div {...FADE_UP} className="glass-panel p-8 md:p-16 rounded-[2.5rem] border border-cyan-500/10 bg-cyan-500/5 relative">
                    ...
                    <div className="max-w-3xl relative z-10">
                        <div className="flex items-center gap-3 mb-8 text-cyan-400 font-mono text-sm tracking-widest uppercase">
                        ...
                        <p className="text-3xl md:text-5xl font-light text-white leading-tight mb-8 font-serif">
                            Average support ticket cost is about <span className="text-cyan-400 font-medium">$15.56</span>. Deflecting 10% of 500,000 tickets saves about <span className="text-cyan-400 font-medium">$0.78 million</span> per year.
                        </p>
            ...
            <section className="px-6 py-24 max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...FADE_UP}>
                        <h2 className="text-sm font-mono tracking-widest uppercase text-cyan-500/70 mb-6 flex items-center">
                            <span className="w-8 h-px bg-cyan-500/30 mr-4" /> The Problem
                        </h2>
            ...
            <section className="px-6 py-24 bg-zinc-900/30 border-y border-white/5 overflow-hidden relative">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <motion.div {...FADE_UP} className="max-w-3xl mb-16">
                        <h2 className="text-sm font-mono tracking-widest uppercase text-cyan-500/70 mb-6 flex items-center">
                            <span className="w-8 h-px bg-cyan-500/30 mr-4" /> Solution Hypothesis
                        </h2>
                        ...
                        <p className="text-2xl text-cyan-400 font-mono font-bold tracking-tight">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mt-16">
                        <motion.div {...FADE_UP} className="glass-panel p-8 rounded-3xl border border-white/5 hover:border-cyan-500/20 transition-colors">
                            <div className="w-12 h-12 rounded-full bg-cyan-500/10 flex items-center justify-center mb-6">
                                <span className="font-mono text-cyan-400 font-bold text-xl">1</span>
                            </div>
                            ...
                            <ul className="space-y-4 text-zinc-400 font-light">
                                <li><strong className="text-cyan-400">Agent Sitemap:</strong> smaller JSON file listing core tasks. Semantic locators prefer ARIA roles over brittle CSS. Instructions stay stable.</li>
                                <li><strong className="text-cyan-400">UI Changefeed:</strong> signed JSON "what changed" feed pushing updated labels immediately.</li>
                                <li><strong className="text-cyan-400">MCP Export:</strong> exposes tasks as MCP tools automatically. Any assistant, same map. <ExpandableCitation title="[3]" source="Model Context Protocol, official specification" url="https://modelcontextprotocol.io/specification/latest" /></li>
                            </ul>
                        </motion.div>

                        <motion.div {...FADE_UP} className="glass-panel p-8 rounded-3xl border border-white/5 hover:border-cyan-500/20 transition-colors">
                            <div className="w-12 h-12 rounded-full bg-cyan-500/10 flex items-center justify-center mb-6">
                                <span className="font-mono text-cyan-400 font-bold text-xl">2</span>
                            </div>
                        ...
                        <motion.div {...FADE_UP} className="glass-panel p-8 rounded-3xl border border-white/5 hover:border-cyan-500/20 transition-colors">
                            <div className="w-12 h-12 rounded-full bg-cyan-500/10 flex items-center justify-center mb-6">
                                <span className="font-mono text-cyan-400 font-bold text-xl">3</span>
                            </div>
                        ...
                        <motion.div {...FADE_UP} className="glass-panel p-8 rounded-3xl border border-white/5 hover:border-cyan-500/20 transition-colors">
                            <div className="w-12 h-12 rounded-full bg-cyan-500/10 flex items-center justify-center mb-6">
                                <span className="font-mono text-cyan-400 font-bold text-xl">4</span>
                            </div>
                        ...
                        <motion.div {...FADE_UP} className="glass-panel p-8 rounded-3xl border border-white/5 hover:border-cyan-500/20 transition-colors lg:col-span-2">
                            <div className="w-12 h-12 rounded-full bg-cyan-500/10 flex items-center justify-center mb-6">
                                <span className="font-mono text-cyan-400 font-bold text-xl">5</span>
                            </div>
            ...
            <section className="px-6 py-24 max-w-7xl mx-auto border-t border-white/5">
                <div className="mb-16">
                    <h2 className="text-sm font-mono tracking-widest uppercase text-cyan-500/70 mb-6 flex items-center">
                        <span className="w-8 h-px bg-cyan-500/30 mr-4" /> Ideal Customer Profile
                    </h2>
                    <h3 className="text-3xl md:text-5xl font-light text-white mb-8 font-serif">
                        A specific example.
                    </h3>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-start">
                    ...
                    <motion.div {...FADE_UP} className="space-y-8">
                        ...
                        <div className="glass-panel p-8 rounded-3xl border border-cyan-500/20 bg-cyan-500/5 relative overflow-hidden group">
                            <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-transparent pointer-events-none" />
                            <div className="w-10 h-10 rounded-full bg-cyan-500/10 flex items-center justify-center mb-6 relative z-10">
                                <span className="font-mono text-cyan-400 font-bold">2</span>
                            </div>
                            <h4 className="text-xl text-cyan-400 font-medium mb-3 relative z-10">The Resolution</h4>
                            <p className="text-zinc-300 leading-relaxed font-light relative z-10 pb-4 border-b border-cyan-500/10 mb-4">
            ...
            <section className="px-6 py-12 pb-24 max-w-7xl mx-auto">
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <motion.div {...FADE_UP} className="group cursor-pointer">
                        <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden mb-6 border border-white/5 group-hover:border-cyan-500/30 transition-colors duration-500">
                            <div className="absolute inset-0 bg-cyan-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10 mix-blend-overlay" />
                            <Image
                        ...
                        <h4 className="text-2xl text-white font-serif mb-3 group-hover:text-cyan-400 transition-colors">Universal Accessibility</h4>
                        <p className="text-zinc-400 font-light leading-relaxed">
                    ...
                    <motion.div {...FADE_UP} className="group cursor-pointer">
                        ...
                        <h4 className="text-2xl text-white font-serif mb-3 group-hover:text-cyan-400 transition-colors">Autonomous Navigation</h4>
                        <p className="text-zinc-400 font-light leading-relaxed">
            ...
            <section className="px-6 py-24 bg-zinc-900/50 border-y border-white/5">
                <div className="max-w-4xl mx-auto">
                    <motion.div {...FADE_UP} className="mb-16">
                        <h2 className="text-sm font-mono tracking-widest uppercase text-cyan-500/70 mb-6 flex items-center">
                            <span className="w-8 h-px bg-cyan-500/30 mr-4" /> Market
                        </h2>
                    ...
                    >
                        <motion.div variants={STAGGER_ITEM} className="glass-panel p-6 rounded-2xl border flex items-start gap-4 hover:bg-white/[0.03] transition-colors border-cyan-500/20">
            ...
            <section className="px-6 py-24 max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...FADE_UP}>
                        <h2 className="text-sm font-mono tracking-widest uppercase text-cyan-500/70 mb-6 flex items-center">
                            <span className="w-8 h-px bg-cyan-500/30 mr-4" /> Why Now
                        </h2>
                        <h3 className="text-3xl md:text-5xl font-light text-white mb-8 font-serif">
                        ...
                        <p className="text-xl text-cyan-400/90 font-serif italic mb-8">
            ...
            <section className="px-6 py-24 bg-zinc-900/30 border-y border-white/5">
                <div className="max-w-4xl mx-auto">
                    <motion.div {...FADE_UP} className="mb-16">
                        <h2 className="text-sm font-mono tracking-widest uppercase text-cyan-500/70 mb-6 flex items-center">
                            <span className="w-8 h-px bg-cyan-500/30 mr-4" /> Business Model
                        </h2>
                    </motion.div>

                    <div className="grid md:grid-cols-2 gap-8 mb-12">
                        {/* B2C */}
                        <motion.div {...FADE_UP} className="glass-panel p-8 rounded-3xl border border-white/5 relative overflow-hidden group hover:border-cyan-500/30 transition-all">
                        ...
                        {/* B2B */}
                        <motion.div {...FADE_UP} className="glass-panel p-8 rounded-3xl border border-cyan-500/20 bg-cyan-500/5 relative overflow-hidden group">
                            <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-transparent pointer-events-none" />
                            <h3 className="text-2xl text-cyan-400 font-serif mb-6 relative z-10">B2B <span className="text-cyan-500/50 font-mono text-sm uppercase tracking-widest ml-2">For Companies</span></h3>
                        ...
                        expandableText={
                            <div className="space-y-6">
                                <div>
                                    ...
                                    Cross-site semantic grounding breaks on dynamic apps, experiments, localization. <span className="text-cyan-400">Mitigation:</span> start with narrow, high-frequency workflows, prefer accessibility-tree-first grounding.
                                </div>
                                <div>
                                    <strong className="text-white block mb-1">Regulatory: Low to Medium Risk</strong>
                                    Privacy, consent, transcript storage. <span className="text-cyan-400">Mitigation:</span> make transcript capture opt-in, anonymize default event logging.
                                </div>
                                <div>
                                    <strong className="text-white block mb-1">Capital: Medium Risk</strong>
                                    Need browser automation infrastructure early. <span className="text-cyan-400">Mitigation:</span> sell measurable ticket-deflection wins before building broad horizontal infrastructure.
                                </div>
                                <div>
                                    <strong className="text-white block mb-1">Execution: High Risk</strong>
                                    Winning trust while maintaining low false-guidance. <span className="text-cyan-400">Mitigation:</span> focus on three repetitive flows first, publish hard outcome metrics.
                                </div>
                            </div>
                        }
                    />
            ...
            <section className="px-6 py-24 bg-zinc-900/50 border-y border-white/5">
                <div className="max-w-4xl mx-auto">
                    <motion.div {...FADE_UP}>
                        <h2 className="text-sm font-mono tracking-widest uppercase text-cyan-500/70 mb-6 flex items-center">
                            <span className="w-8 h-px bg-cyan-500/30 mr-4" /> Go-to-Market
                        </h2>
                    ...
                    <motion.div {...FADE_UP}>
                        <h2 className="text-sm font-mono tracking-widest uppercase text-cyan-500/70 mb-6 flex items-center">
                            <span className="w-8 h-px bg-cyan-500/30 mr-4" /> AGI Future Edge
                        </h2>
            ...
            <section className="px-6 py-24 max-w-4xl mx-auto">
                <motion.div {...FADE_UP}>
                    <h2 className="text-sm font-mono tracking-widest uppercase text-cyan-500/70 mb-6 flex items-center">
                        <span className="w-8 h-px bg-cyan-500/30 mr-4" /> Civilizational Impact
                    </h2>
                    <h3 className="text-3xl md:text-5xl text-white font-serif font-light mb-8 leading-tight">
                        If AI agents become a major way humans interact with digital systems, then <span className="text-cyan-400">legibility becomes a safety primitive</span>.
                    </h3>
                    ...
                    <p className="text-xl text-cyan-400 font-serif italic text-center mt-12 bg-cyan-500/5 p-8 rounded-2xl border border-cyan-500/10">
            ...
            <section className="px-6 py-24 bg-zinc-900/30 border-y border-white/5">
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16">
                    <motion.div {...FADE_UP} className="space-y-12">
                        <div>
                            <h2 className="text-sm font-mono tracking-widest uppercase text-cyan-500/70 mb-6 flex items-center">
                                <span className="w-8 h-px bg-cyan-500/30 mr-4" /> KPIs
                            </h2>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="glass-panel p-4 rounded-xl border border-white/5 hover:border-cyan-500/20 bg-black/20 transition-colors">
                                    <div className="text-cyan-400 font-mono tracking-wider text-xs uppercase mb-1 flex items-center gap-2"><Activity className="w-3.5 h-3.5" /> Coverage</div>
                                    <div className="text-sm text-zinc-300 font-light">Top-20 task coverage rate</div>
                                </div>
                                <div className="glass-panel p-4 rounded-xl border border-white/5 hover:border-cyan-500/20 bg-black/20 transition-colors">
                                    <div className="text-cyan-400 font-mono tracking-wider text-xs uppercase mb-1 flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5" /> Success</div>
                                    <div className="text-sm text-zinc-300 font-light">Task success rate for mapped flows</div>
                                </div>
                                <div className="glass-panel p-4 rounded-xl border border-white/5 hover:border-cyan-500/20 bg-black/20 transition-colors">
                                    <div className="text-cyan-400 font-mono tracking-wider text-xs uppercase mb-1 flex items-center gap-2"><Shield className="w-3.5 h-3.5" /> Deflection</div>
                                    <div className="text-sm text-zinc-300 font-light">Ticket deflection on mapped tasks</div>
                                </div>
                                <div className="glass-panel p-4 rounded-xl border border-white/5 hover:border-cyan-500/20 bg-black/20 transition-colors">
                                    <div className="text-cyan-400 font-mono tracking-wider text-xs uppercase mb-1 flex items-center gap-2"><Activity className="w-3.5 h-3.5" /> Efficiency</div>
                                    <div className="text-sm text-zinc-300 font-light">Step retry rate</div>
                                </div>
                                <div className="glass-panel p-4 rounded-xl border border-white/5 hover:border-cyan-500/20 bg-black/20 transition-colors">
                                    <div className="text-cyan-400 font-mono tracking-wider text-xs uppercase mb-1 flex items-center gap-2"><Globe className="w-3.5 h-3.5" /> Reliability</div>
                                    <div className="text-sm text-zinc-300 font-light">Semantic locator match reliability</div>
                                </div>
                                <div className="glass-panel p-4 rounded-xl border border-white/5 hover:border-cyan-500/20 bg-black/20 transition-colors">
                                    <div className="text-cyan-400 font-mono tracking-wider text-xs uppercase mb-1 flex items-center gap-2"><Users className="w-3.5 h-3.5" /> Satisfaction</div>
                        ...
                        <div>
                            <h2 className="text-sm font-mono tracking-widest uppercase text-cyan-500/70 mb-6 flex items-center">
                                <span className="w-8 h-px bg-cyan-500/30 mr-4" /> Transferable Insight
                            </h2>
                    ...
                    <motion.div {...FADE_UP} className="space-y-8">
                        ...
                        <details className="group glass-panel p-6 rounded-3xl border border-white/5 bg-black/20 [&_summary::-webkit-details-marker]:hidden cursor-pointer">
                            <summary className="flex items-center justify-between text-white">
                                ...
                                <ChevronDown className="w-5 h-5 transition-transform duration-300 group-open:rotate-180 text-cyan-500" />
                            </summary>
                            <div className="mt-6 text-zinc-400 font-light leading-relaxed border-t border-white/5 pt-6 space-y-4">
                                <p><strong className="text-white block mb-1">Quick falsifiable hypothesis:</strong> for one high-friction account flow, a live UI map plus guidance overlay will reduce failed completions by at least <strong className="text-cyan-400">20%</strong> versus control within two weeks.</p>
                        ...
                        <details className="group glass-panel p-6 rounded-3xl border border-white/5 bg-black/20 [&_summary::-webkit-details-marker]:hidden cursor-pointer">
                            ...
                            <div className="mt-6 text-zinc-400 font-light leading-relaxed border-t border-white/5 pt-6 space-y-4">
                                ...
                                <p><strong className="text-white block mb-1">Win criteria:</strong> at least <strong className="text-cyan-400">10% ticket deflection</strong> on those tasks, at least <strong className="text-cyan-400">25% fewer step retries</strong>, and a ranked list of long-tail UX issues with screenshots and optional transcript snippets. Then expand.</p>
                            </div>
                        </details>
                    </motion.div>
                </div>
                ...
                <details className="group [&_summary::-webkit-details-marker]:hidden">
                    ...
                    >
                        <p className="flex flex-col gap-1">
                            ...
                            <a href="https://www.thinkhdi.com/library/supportworld/2017/metric-of-month-desktop-support-cost-per-ticket" target="_blank" className="text-cyan-500 hover:text-cyan-400 hover:underline inline-flex items-center gap-1 transition-colors">
                        ...
                        <p className="flex flex-col gap-1">
                            ...
                            <a href="https://baymard.com/lists/cart-abandonment-rate" target="_blank" className="text-cyan-500 hover:text-cyan-400 hover:underline inline-flex items-center gap-1 transition-colors">
                        ...
                        <p className="flex flex-col gap-1">
                            ...
                            <a href="https://modelcontextprotocol.io/specification/latest" target="_blank" className="text-cyan-500 hover:text-cyan-400 hover:underline inline-flex items-center gap-1 transition-colors">
                        ...
                        <p className="flex flex-col gap-1">
                            ...
                            <a href="https://blog.google/technology/google-deepmind/gemini-computer-use-model/" target="_blank" className="text-cyan-500 hover:text-cyan-400 hover:underline inline-flex items-center gap-1 transition-colors">
                        ...
                        <p className="flex flex-col gap-1">
                            ...
                            <a href="https://www.businesswire.com/news/home/20251008408822/en/1Password-and-Browserbase-Partner-to-Secure-Credential-Access-for-Agentic-AI-Automation" target="_blank" className="text-cyan-500 hover:text-cyan-400 hover:underline inline-flex items-center gap-1 transition-colors">
                        ...
                        <p className="flex flex-col gap-1">
                            ...
                            <a href="https://my.idc.com/getdoc.jsp?containerId=prUS52530724" target="_blank" className="text-cyan-500 hover:text-cyan-400 hover:underline inline-flex items-center gap-1 transition-colors">
                        ...
                        <p className="flex flex-col gap-1">
                            ...
                            <a href="https://www.grandviewresearch.com/industry-analysis/ai-agents-market-report" target="_blank" className="text-cyan-500 hover:text-cyan-400 hover:underline inline-flex items-center gap-1 transition-colors">
                        ...
                        <p className="flex flex-col gap-1">
                            ...
                            <a href="https://www.uctoday.com/unified-communications/gartner-predicts-40-of-enterprise-apps-will-feature-ai-agents-by-2026/" target="_blank" className="text-cyan-500 hover:text-cyan-400 hover:underline inline-flex items-center gap-1 transition-colors">
