        ...
        <main className="min-h-screen bg-[#06090c] text-[var(--tertiary)] selection:bg-[var(--primary)]/30 overflow-x-hidden font-sans pb-32" style={{ "--primary": themeMap['cyan'].hexPrimary, "--secondary": themeMap['cyan'].hexSecondary, "--tertiary": themeMap['cyan'].hexTertiary } as React.CSSProperties}>
            ...
            <section className="px-6 py-24 bg-transparent border-y border-white/5">
                <motion.div {...FADE_UP} className="max-w-4xl mx-auto text-center">
                    <p className="text-2xl md:text-3xl lg:text-4xl text-white font-serif leading-relaxed font-light">
                        ...
                        <span className="text-[var(--secondary)]"> Agentable makes that operating system readable in real time. </span>
                ...
                <motion.div {...FADE_UP} className="glass-panel p-8 md:p-16 rounded-[2.5rem] border border-[var(--primary)]/10 bg-[var(--primary)]/5 relative">
                    ...
                    <div className="max-w-3xl relative z-10">
                        ...
                        <p className="text-3xl md:text-5xl font-light text-white leading-tight mb-8 font-serif">
                            Average support ticket cost is about <span className="text-[var(--secondary)] font-medium">$15.56</span>. Deflecting 10% of 500,000 tickets saves about <span className="text-[var(--secondary)] font-medium">$0.78 million</span> per year.
                        </p>
                        <p className="text-xl text-[var(--secondary)] leading-relaxed font-light">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...FADE_UP}>
                        <h2 className="text-sm font-mono tracking-widest uppercase text-[var(--primary)]/70 mb-6 flex items-center">
                            <span className="w-8 h-px bg-[var(--primary)]/30 mr-4" /> The Problem
                        </h2>
                        <h3 className="text-3xl md:text-5xl font-light text-white mb-8 font-serif">
                            Interfaces change faster than documentation.
                        </h3>
                        <p className="text-xl text-[var(--secondary)] leading-relaxed font-light mb-6">
                        ...
                        <InlineTags tags={['Trust', 'Coordination']} label="Bottleneck" theme="cyan" />
                    </motion.div>
                    <motion.div
                        {...FADE_UP}
            ...
            <section className="px-6 py-24 bg-transparent border-y border-white/5 overflow-hidden relative">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <motion.div {...FADE_UP} className="max-w-3xl mb-16">
                        ...
                        <p className="text-xl text-[var(--secondary)] font-light leading-relaxed mb-6">
                        ...
                        <p className="text-2xl text-[var(--secondary)] font-mono font-bold tracking-tight">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mt-16">
                        <motion.div {...FADE_UP} className="glass-panel p-8 rounded-3xl border border-white/5 hover:border-[var(--primary)]/20 transition-colors">
                            <div className="w-12 h-12 rounded-full bg-[var(--primary)]/10 flex items-center justify-center mb-6">
                                <span className="font-mono text-[var(--secondary)] font-bold text-xl">1</span>
                            </div>
                            <h4 className="text-xl text-white mb-4">Dev-published updates, preferred path</h4>
                            <ul className="space-y-4 text-[var(--secondary)] font-light">
                                <li><strong className="text-[var(--secondary)]">Agent Sitemap:</strong> smaller JSON file listing core tasks. Semantic locators prefer ARIA roles over brittle CSS. Instructions stay stable.</li>
                                <li><strong className="text-[var(--secondary)]">UI Changefeed:</strong> signed JSON "what changed" feed pushing updated labels immediately.</li>
                                <li><strong className="text-[var(--secondary)]">MCP Export:</strong> exposes tasks as MCP tools automatically. Any assistant, same map. <ExpandableCitation title="[3]" source="Model Context Protocol, official specification" url="https://modelcontextprotocol.io/specification/latest" /></li>
                            </ul>
                        </motion.div>

                        <motion.div {...FADE_UP} className="glass-panel p-8 rounded-3xl border border-white/5 hover:border-[var(--primary)]/20 transition-colors">
                            <div className="w-12 h-12 rounded-full bg-[var(--primary)]/10 flex items-center justify-center mb-6">
                                <span className="font-mono text-[var(--secondary)] font-bold text-xl">2</span>
                            </div>
                            ...
                            <p className="text-[var(--secondary)] font-light leading-relaxed">
                                Risk-weighted crawls open key flows, read the <strong className="text-[var(--primary)]">Accessibility Tree</strong>, verify steps. Critical flows validate more often. Catches silent breakage on sites without published updates.
                            </p>
                        </motion.div>

                        <motion.div {...FADE_UP} className="glass-panel p-8 rounded-3xl border border-white/5 hover:border-[var(--primary)]/20 transition-colors">
                            <div className="w-12 h-12 rounded-full bg-[var(--primary)]/10 flex items-center justify-center mb-6">
                                <span className="font-mono text-[var(--secondary)] font-bold text-xl">3</span>
                            </div>
                            <h4 className="text-xl text-white mb-4">Two runtimes, one spec</h4>
                            <ul className="space-y-4 text-[var(--secondary)] font-light">
                                <li><strong className="text-[var(--primary)]">Human Guidance Overlay:</strong> native overlay highlights right controls, offers fallbacks on demand.</li>
                                <li><strong className="text-[var(--primary)]">Agent Tools:</strong> same taskscallable by assistants like Gemini Computer Use. Your site is agent-friendly by design. <ExpandableCitation title="[4]" source="Google, Introducing the Gemini 2.5 Computer Use model" url="https://blog.google/technology/google-deepmind/gemini-computer-use-model/" /></li>
                            </ul>
                        </motion.div>

                        <motion.div {...FADE_UP} className="glass-panel p-8 rounded-3xl border border-white/5 hover:border-[var(--primary)]/20 transition-colors">
                            <div className="w-12 h-12 rounded-full bg-[var(--primary)]/10 flex items-center justify-center mb-6">
                                <span className="font-mono text-[var(--secondary)] font-bold text-xl">4</span>
                            </div>
                            <h4 className="text-xl text-white mb-4">Secure agentic logins</h4>
                            <p className="text-[var(--secondary)] font-light leading-relaxed">
                                <strong className="text-[var(--primary)]">1Password Secure Agentic Autofill:</strong> enterprise-safe credentials for hosted agent browsers. <ExpandableCitation title="[5]" source="1Password and Browserbase Partner..." url="https://www.businesswire.com/news/home/20251008408822/en/1Password-and-Browserbase-Partner-to-Secure-Credential-Access-for-Agentic-AI-Automation" />
                            </p>
                        </motion.div>

                        <motion.div {...FADE_UP} className="glass-panel p-8 rounded-3xl border border-white/5 hover:border-[var(--primary)]/20 transition-colors lg:col-span-2">
                            <div className="w-12 h-12 rounded-full bg-[var(--primary)]/10 flex items-center justify-center mb-6">
                                <span className="font-mono text-[var(--secondary)] font-bold text-xl">5</span>
                            </div>
                            <h4 className="text-xl text-white mb-4">Convert navigation into insight</h4>
                            <p className="text-[var(--secondary)] font-light leading-relaxed max-w-2xl">
                                <strong className="text-[var(--primary)]">Telemetry:</strong> logs quantitative and qualitative signals routing straight to Dev issue trackers.
                            </p>
                        </motion.div>
                    </div>
                </div>
                    ...
                    <motion.div {...FADE_UP} className="space-y-8">
                        <div className="glass-panel p-8 rounded-3xl border border-white/5 relative overflow-hidden group">
                            <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center mb-6">
                                <span className="font-mono text-[var(--secondary)] font-bold">1</span>
                            </div>
                            <h4 className="text-xl text-white font-medium mb-3">The Problem</h4>
                            <p className="text-[var(--secondary)] leading-relaxed font-light">
                                A subscription software company maps three painful account tasks: Reset Password, Update Billing, and Change Plan.
                            </p>
                        </div>

                        <div className="glass-panel p-8 rounded-3xl border border-[var(--primary)]/20 bg-[var(--primary)]/5 relative overflow-hidden group">
                            <div className="absolute inset-0 bg-gradient-to-br from-[var(--primary)]/5 to-transparent pointer-events-none" />
                            <div className="w-10 h-10 rounded-full bg-[var(--primary)]/10 flex items-center justify-center mb-6 relative z-10">
                                <span className="font-mono text-[var(--secondary)] font-bold">2</span>
                            </div>
                            <h4 className="text-xl text-[var(--secondary)] font-medium mb-3 relative z-10">The Resolution</h4>
                            <p className="text-[var(--tertiary)] leading-relaxed font-light relative z-10 pb-4 border-b border-[var(--primary)]/10 mb-4">
                            ...
                            <p className="text-[var(--tertiary)] leading-relaxed font-light relative z-10">
            ...
            <section className="px-6 py-12 pb-24 max-w-7xl mx-auto">
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <motion.div {...FADE_UP} className="group cursor-pointer">
                        <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden mb-6 border border-white/5 group-hover:border-[var(--primary)]/30 transition-colors duration-500">
                            <div className="absolute inset-0 bg-[var(--primary)]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10 mix-blend-overlay" />
                            <Image
                        ...
                        <h4 className="text-2xl text-white font-serif mb-3 group-hover:text-[var(--secondary)] transition-colors">Universal Accessibility</h4>
                        <p className="text-[var(--secondary)] font-light leading-relaxed">
                    ...
                    <motion.div {...FADE_UP} className="group cursor-pointer">
                        ...
                        <h4 className="text-2xl text-white font-serif mb-3 group-hover:text-[var(--secondary)] transition-colors">Autonomous Navigation</h4>
                        <p className="text-[var(--secondary)] font-light leading-relaxed">
            ...
            <section className="px-6 py-24 bg-transparent border-y border-white/5">
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        <motion.div variants={STAGGER_ITEM} className="glass-panel p-6 rounded-2xl border flex items-start gap-4 hover:bg-white/[0.03] transition-colors border-[var(--primary)]/20">
                            <div className="bg-[var(--primary)]/10 p-2 rounded-lg text-[var(--secondary)] shrink-0">
                                <Network className="w-5 h-5" />
                            </div>
                            <div>
                                <h4 className="font-semibold text-white mb-2 tracking-tight">Layer 1: Support & Conversion</h4>
                                <p className="text-sm text-[var(--secondary)] font-light">Enterprise teams buy because confusion is already expensive.</p>
                            </div>
                        </motion.div>
                        ...
                        <motion.div variants={STAGGER_ITEM} className="glass-panel p-6 rounded-2xl border flex items-start gap-4 hover:bg-white/[0.03] transition-colors border-white/10">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-[var(--secondary)] font-light">The live UI map becomes an always-on validation layer for critical flows.</p>
                            </div>
                        </motion.div>
                        ...
                        <motion.div variants={STAGGER_ITEM} className="glass-panel p-6 rounded-2xl border flex items-start gap-4 hover:bg-white/[0.03] transition-colors border-[var(--primary)]/20">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-[var(--secondary)] font-light">Reliably machine-readable sites get preferred treatment from assistants and marketplaces.</p>
                            </div>
                        </motion.div>
                        ...
                        <motion.div variants={STAGGER_ITEM} className="glass-panel p-6 rounded-2xl border flex items-start gap-4 hover:bg-white/[0.03] transition-colors border-[var(--primary)]/20">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-[var(--secondary)] font-light">The winning company becomes the neutral trust layer between websites, humans, and AI agents.</p>
                            </div>
                        </motion.div>
                    </motion.div>
                </div>
            ...
            <section className="px-6 py-24 max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div {...FADE_UP}>
                        <h2 className="text-sm font-mono tracking-widest uppercase text-[var(--primary)]/70 mb-6 flex items-center">
                            <span className="w-8 h-px bg-[var(--primary)]/30 mr-4" /> Why Now
                        </h2>
                        <h3 className="text-3xl md:text-5xl font-light text-white mb-8 font-serif">
                        ...
                        <div className="space-y-6 mb-12">
                            <div className="flex gap-4 items-start">
                                ...
                                <p className="text-lg text-[var(--secondary)] font-light"><strong className="text-white">Models can now operate browsers.</strong> Computer-use systems have made live UI interaction economically real.</p>
                            </div>
                            <div className="flex gap-4 items-start">
                                <div className="w-1.5 h-1.5 rounded-full bg-[var(--primary)] mt-2 shrink-0" />
                                <p className="text-lg text-[var(--secondary)] font-light"><strong className="text-white">A neutral standard now exists.</strong> MCP makes cross-model tooling portable enough for one map to serve many assistants.</p>
                            </div>
                            <div className="flex gap-4 items-start">
                                <div className="w-1.5 h-1.5 rounded-full bg-[var(--primary)] mt-2 shrink-0" />
                                <p className="text-lg text-[var(--secondary)] font-light"><strong className="text-white">The budget owner already exists.</strong> Support and self-serve teams already measure the cost of confusion and can justify spend fast.</p>
                            </div>
                        </div>

                        <p className="text-xl text-[var(--secondary)]/90 font-serif italic mb-8">
            ...
            <section className="px-6 py-24 bg-transparent border-y border-white/5">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-12">
                        {/* B2C */}
                        <motion.div {...FADE_UP} className="glass-panel p-8 rounded-3xl border border-white/5 relative overflow-hidden group hover:border-[var(--primary)]/30 transition-all">
                            <div className="absolute inset-0 bg-gradient-to-br from-white/[0.02] to-transparent pointer-events-none" />
                            <h3 className="text-2xl text-white font-serif mb-6 relative z-10">B2C <span className="text-[var(--primary)] font-mono text-sm uppercase tracking-widest ml-2">For People</span></h3>
                            <ul className="space-y-4 text-[var(--secondary)] font-light relative z-10">
                        ...
                        {/* B2B */}
                        <motion.div {...FADE_UP} className="glass-panel p-8 rounded-3xl border border-[var(--primary)]/20 bg-[var(--primary)]/5 relative overflow-hidden group">
                            <div className="absolute inset-0 bg-gradient-to-br from-[var(--primary)]/5 to-transparent pointer-events-none" />
                            <h3 className="text-2xl text-[var(--secondary)] font-serif mb-6 relative z-10">B2B <span className="text-[var(--primary)]/50 font-mono text-sm uppercase tracking-widest ml-2">For Companies</span></h3>
                            <ul className="space-y-4 text-[var(--tertiary)] font-light relative z-10">
                            ...
                            <InlineTags tags={['Platform', 'Infrastructure']} theme="cyan" />
                        </motion.div>
                    </div>
                </div>
            </section>
                        ...
                        expandableText={
                            <div className="space-y-6">
                                <div>
                                    ...
                                    Cross-site semantic grounding breaks on dynamic apps, experiments, localization. <span className="text-[var(--secondary)]">Mitigation:</span> start with narrow, high-frequency workflows, prefer accessibility-tree-first grounding.
                                </div>
                                <div>
                                    <strong className="text-white block mb-1">Regulatory: Low to Medium Risk</strong>
                                    Privacy, consent, transcript storage. <span className="text-[var(--secondary)]">Mitigation:</span> make transcript capture opt-in, anonymize default event logging.
                                </div>
                                <div>
                                    <strong className="text-white block mb-1">Capital: Medium Risk</strong>
                                    Need browser automation infrastructure early. <span className="text-[var(--secondary)]">Mitigation:</span> sell measurable ticket-deflection wins before building broad horizontal infrastructure.
                                </div>
                                <div>
                                    <strong className="text-white block mb-1">Execution: High Risk</strong>
                                    Winning trust while maintaining low false-guidance. <span className="text-[var(--secondary)]">Mitigation:</span> focus on three repetitive flows first, publish hard outcome metrics.
                                </div>
                            </div>
                        }
                    />
            ...
            <section className="px-6 py-24 bg-transparent border-y border-white/5">
                <div className="max-w-4xl mx-auto">
                    <motion.div {...FADE_UP}>
                        <h2 className="text-sm font-mono tracking-widest uppercase text-[var(--primary)]/70 mb-6 flex items-center">
                            <span className="w-8 h-px bg-[var(--primary)]/30 mr-4" /> Go-to-Market
                        </h2>
                        <h3 className="text-3xl text-white font-serif mb-6">Launch the Agentability Index</h3>
                        <p className="text-xl text-[var(--secondary)] font-light mb-12">
                        ...
                        <InlineTags tags={['Technical Founder', 'Venture-Scale']} label="Founder Fit" theme="cyan" />
                    </motion.div>
                    ...
                    <motion.div {...FADE_UP}>
                        <h2 className="text-sm font-mono tracking-widest uppercase text-[var(--primary)]/70 mb-6 flex items-center">
                            <span className="w-8 h-px bg-[var(--primary)]/30 mr-4" /> AGI Future Edge
                        </h2>
                        <h3 className="text-3xl text-white font-serif mb-6">Humans and agents learn from the same map.</h3>
                        <div className="grid md:grid-cols-2 gap-8 text-[var(--secondary)] font-light">
                            <div>
            ...
            <section className="px-6 py-24 max-w-4xl mx-auto">
                <motion.div {...FADE_UP}>
                    ...
                    <h3 className="text-3xl md:text-5xl text-white font-serif font-light mb-8 leading-tight">
                        If AI agents become a major way humans interact with digital systems, then <span className="text-[var(--secondary)]">legibility becomes a safety primitive</span>.
                    </h3>
                    <p className="text-xl text-[var(--secondary)] font-light leading-relaxed mb-12">
                    ...
                    <p className="text-xl text-[var(--secondary)] font-serif italic text-center mt-12 bg-[var(--primary)]/5 p-8 rounded-2xl border border-[var(--primary)]/10">
            ...
            <section className="px-6 py-24 bg-transparent border-y border-white/5">
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16">
                    <motion.div {...FADE_UP} className="space-y-12">
                        <div>
                            <h2 className="text-sm font-mono tracking-widest uppercase text-[var(--primary)]/70 mb-6 flex items-center">
                                <span className="w-8 h-px bg-[var(--primary)]/30 mr-4" /> KPIs
                            </h2>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="glass-panel p-4 rounded-xl border border-white/5 hover:border-[var(--primary)]/20 bg-black/20 transition-colors">
                                    <div className="text-[var(--secondary)] font-mono tracking-wider text-xs uppercase mb-1 flex items-center gap-2"><Activity className="w-3.5 h-3.5" /> Coverage</div>
                                    <div className="text-sm text-[var(--tertiary)] font-light">Top-20 task coverage rate</div>
                                </div>
                                <div className="glass-panel p-4 rounded-xl border border-white/5 hover:border-[var(--primary)]/20 bg-black/20 transition-colors">
                                    <div className="text-[var(--secondary)] font-mono tracking-wider text-xs uppercase mb-1 flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5" /> Success</div>
                                    <div className="text-sm text-[var(--tertiary)] font-light">Task success rate for mapped flows</div>
                                </div>
                                <div className="glass-panel p-4 rounded-xl border border-white/5 hover:border-[var(--primary)]/20 bg-black/20 transition-colors">
                                    <div className="text-[var(--secondary)] font-mono tracking-wider text-xs uppercase mb-1 flex items-center gap-2"><Shield className="w-3.5 h-3.5" /> Deflection</div>
                                    <div className="text-sm text-[var(--tertiary)] font-light">Ticket deflection on mapped tasks</div>
                                </div>
                                <div className="glass-panel p-4 rounded-xl border border-white/5 hover:border-[var(--primary)]/20 bg-black/20 transition-colors">
                                    <div className="text-[var(--secondary)] font-mono tracking-wider text-xs uppercase mb-1 flex items-center gap-2"><Activity className="w-3.5 h-3.5" /> Efficiency</div>
                                    <div className="text-sm text-[var(--tertiary)] font-light">Step retry rate</div>
                                </div>
                                <div className="glass-panel p-4 rounded-xl border border-white/5 hover:border-[var(--primary)]/20 bg-black/20 transition-colors">
                                    <div className="text-[var(--secondary)] font-mono tracking-wider text-xs uppercase mb-1 flex items-center gap-2"><Globe className="w-3.5 h-3.5" /> Reliability</div>
                                    <div className="text-sm text-[var(--tertiary)] font-light">Semantic locator match reliability</div>
                                </div>
                                <div className="glass-panel p-4 rounded-xl border border-white/5 hover:border-[var(--primary)]/20 bg-black/20 transition-colors">
                                    <div className="text-[var(--secondary)] font-mono tracking-wider text-xs uppercase mb-1 flex items-center gap-2"><Users className="w-3.5 h-3.5" /> Satisfaction</div>
                                    <div className="text-sm text-[var(--tertiary)] font-light">Post-task NPS & time-to-fix</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <h2 className="text-sm font-mono tracking-widest uppercase text-[var(--primary)]/70 mb-6 flex items-center">
                                <span className="w-8 h-px bg-[var(--primary)]/30 mr-4" /> Transferable Insight
                            </h2>
                            <p className="text-xl text-[var(--secondary)] font-light leading-relaxed">
                    ...
                    <motion.div {...FADE_UP} className="space-y-8">
                        ...
                        <details className="group glass-panel p-6 rounded-3xl border border-white/5 bg-black/20 [&_summary::-webkit-details-marker]:hidden cursor-pointer">
                            <summary className="flex items-center justify-between text-white">
                                ...
                                <ChevronDown className="w-5 h-5 transition-transform duration-300 group-open:rotate-180 text-[var(--primary)]" />
                            </summary>
                            <div className="mt-6 text-[var(--secondary)] font-light leading-relaxed border-t border-white/5 pt-6 space-y-4">
                                <p><strong className="text-white block mb-1">Quick falsifiable hypothesis:</strong> for one high-friction account flow, a live UI map plus guidance overlay will reduce failed completions by at least <strong className="text-[var(--secondary)]">20%</strong> versus control within two weeks.</p>
                        ...
                        <details className="group glass-panel p-6 rounded-3xl border border-white/5 bg-black/20 [&_summary::-webkit-details-marker]:hidden cursor-pointer">
                            ...
                            <div className="mt-6 text-[var(--secondary)] font-light leading-relaxed border-t border-white/5 pt-6 space-y-4">
                                ...
                                <p><strong className="text-white block mb-1">Win criteria:</strong> at least <strong className="text-[var(--secondary)]">10% ticket deflection</strong> on those tasks, at least <strong className="text-[var(--secondary)]">25% fewer step retries</strong>, and a ranked list of long-tail UX issues with screenshots and optional transcript snippets. Then expand.</p>
                            </div>
                        </details>
                    </motion.div>
                </div>
            ...
            <section className="px-6 py-24 max-w-4xl mx-auto border-t border-white/5">
                <details className="group [&_summary::-webkit-details-marker]:hidden">
                    <summary className="flex items-center justify-between cursor-pointer text-[var(--primary)] hover:text-white transition-colors duration-300">
                    ...
                    <motion.div
                        ...
                        className="overflow-hidden mt-8 text-sm text-[var(--secondary)] font-light space-y-4"
                    >
                        <p className="flex flex-col gap-1">
                            <span className="text-white font-medium">[1] HDI, "Metric of the Month: Desktop Support Cost per Ticket."</span>
                            <a href="https://www.thinkhdi.com/library/supportworld/2017/metric-of-month-desktop-support-cost-per-ticket" target="_blank" className="text-[var(--primary)] hover:text-[var(--secondary)] hover:underline inline-flex items-center gap-1 transition-colors">
                        ...
                        <p className="flex flex-col gap-1">
                            ...
                            <a href="https://baymard.com/lists/cart-abandonment-rate" target="_blank" className="text-[var(--primary)] hover:text-[var(--secondary)] hover:underline inline-flex items-center gap-1 transition-colors">
                        ...
                        <p className="flex flex-col gap-1">
                            ...
                            <a href="https://modelcontextprotocol.io/specification/latest" target="_blank" className="text-[var(--primary)] hover:text-[var(--secondary)] hover:underline inline-flex items-center gap-1 transition-colors">
                        ...
                        <p className="flex flex-col gap-1">
                            ...
                            <a href="https://blog.google/technology/google-deepmind/gemini-computer-use-model/" target="_blank" className="text-[var(--primary)] hover:text-[var(--secondary)] hover:underline inline-flex items-center gap-1 transition-colors">
                        ...
                        <p className="flex flex-col gap-1">
                            ...
                            <a href="https://www.businesswire.com/news/home/20251008408822/en/1Password-and-Browserbase-Partner-to-Secure-Credential-Access-for-Agentic-AI-Automation" target="_blank" className="text-[var(--primary)] hover:text-[var(--secondary)] hover:underline inline-flex items-center gap-1 transition-colors">
                        ...
                        <p className="flex flex-col gap-1">
                            ...
                            <a href="https://my.idc.com/getdoc.jsp?containerId=prUS52530724" target="_blank" className="text-[var(--primary)] hover:text-[var(--secondary)] hover:underline inline-flex items-center gap-1 transition-colors">
                        ...
                        <p className="flex flex-col gap-1">
                            ...
                            <a href="https://www.grandviewresearch.com/industry-analysis/ai-agents-market-report" target="_blank" className="text-[var(--primary)] hover:text-[var(--secondary)] hover:underline inline-flex items-center gap-1 transition-colors">
                        ...
                        <p className="flex flex-col gap-1">
                            ...
                            <a href="https://www.uctoday.com/unified-communications/gartner-predicts-40-of-enterprise-apps-will-feature-ai-agents-by-2026/" target="_blank" className="text-[var(--primary)] hover:text-[var(--secondary)] hover:underline inline-flex items-center gap-1 transition-colors">
...
function CivilizationalImpactCard() {
    ...
    return (
        <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-[var(--primary)]/20 relative overflow-hidden group">
            ...
            <div className="relative z-10">
                ...
                <AnimatePresence>
                    {isExpanded && (
                        ...
                        >
                            <div className="pt-8 mt-6 border-t border-[var(--primary)]/20 grid sm:grid-cols-2 gap-6">
                                <div className="p-4 rounded-xl bg-black/20 border border-white/5 flex justify-between items-center">
                                    <span className="text-[var(--tertiary)] font-medium">Abundance</span>
                                    <span className="text-2xl font-light text-[var(--secondary)]">61</span>
                                </div>
                                <div className="p-4 rounded-xl bg-black/20 border border-white/5 flex justify-between items-center">
                                    <span className="text-[var(--tertiary)] font-medium">Social Trust</span>
                                    <span className="text-2xl font-light text-[var(--secondary)]">58</span>
                                </div>
                                <div className="p-4 rounded-xl bg-black/20 border border-white/5 flex justify-between items-center">
                                    <span className="text-[var(--tertiary)] font-medium">Alignment</span>
                                    <span className="text-2xl font-light text-[var(--secondary)]">49</span>
                                </div>
                                <div className="p-4 rounded-xl bg-black/20 border border-white/5 flex justify-between items-center">
                                    <span className="text-[var(--tertiary)] font-medium">Differentially Defensive</span>
                                    <span className="text-2xl font-light text-[var(--secondary)]">47</span>
                                </div>
                            </div>
                        </motion.div>
                    )}
