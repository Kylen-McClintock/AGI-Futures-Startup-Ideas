                ...
                <div className="max-w-3xl mx-auto px-6 space-y-32">
                    ...
                    <section>
                        ...
                        <p className="text-lg text-white/80 leading-relaxed font-light">
                            About 1 in 3 U.S. adults report feeling lonely, while 22.7 million renter households and 20.7 million homeowner households were housing cost-burdened in 2024. That is not two separate problems. It is one opening. <ExpandableCitation number={1} source="CDC" title="Health Effects of Social Isolation and Loneliness" /> <ExpandableCitation number={4} source="Harvard JCHS" title="Housing Unaffordability Soared to New Highs in 2024" />
                        </p>
                    </section>
                    ...
                    <section className="pt-12 border-t border-white/10 mt-24">
                        ...
                        <p className="text-lg text-white/80 leading-relaxed font-light mb-8">
                            Social connection is not a soft benefit. It is tied to depression risk, chronic disease management, and broader health outcomes. <ExpandableCitation number={1} source="CDC" title="Health Effects of Social Isolation" /> <ExpandableCitation number={7} source="National Academies" title="Social Isolation in Older Adults" /> <ExpandableCitation number={8} source="HHS" title="Social Connection Facts" />
                        </p>
