...
export default function AvatarLabClientPage({ initialTags }: { initialTags: ProjectTagsProps['tags'] }) {
    ...
    return (
        <main className="min-h-screen bg-[var(--primary)] text-slate-200 selection:bg-[var(--primary)]/30 font-sans pb-32" style={{ "--primary": themeMap['teal'].hexPrimary, "--secondary": themeMap['teal'].hexSecondary, "--tertiary": themeMap['teal'].hexTertiary } as React.CSSProperties}>
